            ...
            <div className="container-fluid footer-block mt-5">
                <div className="row d-flex justify-content-around align-content-center align-items-center">
                    ...
                    <div className="col-xl-2 d-flex flex-column justify-content-center">
                        <img className='p-0 m-0 ' src={logo} alt="" height={200}/>
                        <p className='text-center m-0'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Necessitatibus totam quae reprehenderit vel illo aperiam dolorum! Blanditiis accusantium nisi cum!</p>
                    </div>
                </div>
            </div>
        </div>
